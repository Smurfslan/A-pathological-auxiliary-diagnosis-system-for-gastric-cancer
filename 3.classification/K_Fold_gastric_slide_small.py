...
def main():
    ...
    batch_size = 4
    epochs = 30
    csv_file = '/mnt/ai2019/ljl/code/software_platform/infer/matrix/small/train_Semi_ts_0.3_DeepLabV3Plus_b3_classification_small.csv'
    test_csv_file = '/mnt/ai2019/ljl/code/software_platform/infer/matrix/small/test_Semi_ts_0.3_DeepLabV3Plus_b3_classification_small.csv'
    save_path = '/mnt/ai2019/ljl/code/gastric_slide_classification/K_fold_model_small/'
    results = '/mnt/ai2019/ljl/code/gastric_slide_classification/results_small/'
    ...
    for k, (train_index, test_index) in enumerate(kf.split(imgs)):
        ...
        # pthfile = '/mnt/ai2019/ljl/code/gastric_slide_classification/efficientnet_b3_ra2-cf984f9c.pth'
        # net.load_state_dict(torch.load(pthfile))
        # net.classifier = nn.Linear(in_features=1536, out_features=2, bias=True)
        ...
        for epoch in range(epochs):
            ...
            if val_accurate >= best_acc:
                ...
                torch.save(net.state_dict(), save_path+model_name+'.pth')
        ...
        # test
        net.load_state_dict(torch.load(save_path + model_name + '.pth', map_location=device))
        net.eval()
        gt_list = []
        pre_list = []
        pre_score = []
        ...
        if sensitivity_tmap > sensitivity:
            ...
            # torch.save(net.state_dict(), save_path + model_name + '_best.pth')
